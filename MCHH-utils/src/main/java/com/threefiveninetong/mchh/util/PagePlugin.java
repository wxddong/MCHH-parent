		...
		if (ivk.getTarget() instanceof RoutingStatementHandler) {
			...
			if (mappedStatement.getId().matches(pageSqlId)) { 
				...
				if (parameterObject == null) {
					...
					MetaObject metaParameters = (MetaObject) ReflectHelper.getValueByFieldName(boundSql, "metaParameters");
					ReflectHelper.setValueByFieldName(countBS, "metaParameters", metaParameters);
