...
<script type="text/javascript">
    ...
    <div id="base" class="">
      ...
      <div id="u12" class="ax_文本段落">
         <p id="u13"><span>姓&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;名： ${archivesInfoDetail.archivesInfo.manName }</span></p>
      </div>
      ...
      <div id="u16" class="ax_文本段落">
          ...
          <p id="u17"><span>国&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;籍：
				<c:if test="${archivesInfoDetail.archivesInfo.manInte eq '1'}">
          			外国
          		</c:if>
          		<c:if test="${archivesInfoDetail.archivesInfo.manInte eq '0'}">
          			中国
          		</c:if>
          	</span></p>
      </div>
      ...
      <div id="u30" class="ax_文本段落">
          ...
          <p id="u31"><span>民&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;族：${archivesInfoDetail.archivesInfo.manNation }</span></p>
      ...
      <div id="u20" class="ax_文本段落">
          ...
          <p id="u21"><span>身份证号：${archivesInfoDetail.archivesInfo.manIdNo }</span></p>
      ...
      <div id="u38" class="ax_文本段落">
          ...
          <p id="u39"><span>出生日期：<span id = "birthday">${archivesInfoDetail.manBirthday }</span></span></p>
      ...
      <div id="u32" class="ax_文本段落">
          ...
          <p id="u33"><span>户籍类型：
          		<c:if test="${archivesInfoDetail.archivesInfo.manHouType eq '0'}">
          			本地
          		</c:if>
          		<c:if test="${archivesInfoDetail.archivesInfo.manHouType eq '1'}">
          			外地
          		</c:if>
          </span></p>
      ...
      <div id="u28" class="ax_文本段落">
          ...
          <p id="u29"><span>工作单位：${archivesInfoDetail.archivesInfo.manWorkUnit }</span></p>
      ...
      <div id="u48" class="ax_文本段落">
          ...
          <p id="u49"><span>联系电话：${archivesInfoDetail.archivesInfo.manTele }</span></p>
      ...
      <div id="u40" class="ax_文本段落">
          ...
          <p id="u41"><span>紧急电话：${archivesInfoDetail.archivesInfo.manUrgentCall }</span></p>
      ...
      <div id="u42" class="ax_文本段落">
          ...
          <p id="u43"><span>对方姓名：${archivesInfoDetail.archivesInfo.name }</span></p>
      ...
      <div id="u44" class="ax_文本段落">
          ...
          <p id="u45"><span>身份证号：${archivesInfoDetail.archivesInfo.idNo }</span></p>
      ...
      <div id="u46" class="ax_文本段落">
          ...
          <p id="u47"><span>联系电话：${archivesInfoDetail.archivesInfo.telephone }</span></p>
