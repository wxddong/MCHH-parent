   ...
   <script type="text/javascript">
     ...
     /* 展开和收起 */
		 	...
		 	$(function(){
		    					  ...
		    					  for(var i = 0;i<data.list3.length;i++){
		    						  if (i < 7) {
		    							  she1 += "<div class='gu5' style='position:absolute;width:250px;height:15px;left:30px;top:"+(71+a*50)+"px;vertical-align: baseline;'><label>"
			     							+"<p class='ps'><span>"+data.list3[i].name+"</span></p>"+
			     							"</label><input class='in' type='checkbox' value='"+data.list3[i].id+"'name='reproductiveDis'/>"
			     							+"</div>";
	    		...
	    		//特殊疾病保存
	    		saveSpecialUrl = "${ctx}/specialdiseaseinfo/manAdd"
 	 		  ...
 	 		  $.ajax({
 	 			  dataType:'json',
 	 	 		  ...
 	 	 		  success:function(data){
	 	 	 		  ...
	 	 	 		  var str3 = "" ;
	 	 	 		  for(var i = 0;i<data.list3.length;i++){
	 	 	 			  str3 += "<option value="+data.list3[i].id+">"+data.list3[i].name+"</option>" ;
	 	 	 		  }
	 	 	 		  str3 += "<option value='38'>其他</option>" ;
	 	 	 		  $("#u526_input").html(str3);
				...
				$("input[name^='referral']").click(function(){
			        ...
			        if($("#u225_input").attr("checked")){
			            ...
			            /* document.getElementById("u511_input").value=(year)+"-"+(month)+"-"+(date);
				 		...
				 		//document.getElementById("u238_input").disabled=false;
...
<div id="u3" class="ax_形状" style="display:none">
         <p id="u260"><span>血缘关系</span><span>：</span></p>
  		...
  		<select id="u262_input" class = "test" name = "kinship">
  ...
  <select id="u634_input" name = "surgeryHistory" class = "test">
          <option selected value="0">无</option>
          <option value="1">有</option>
        </select>

  <input id="u635_input" name = "operation" type="text" value="" placeholder = "有时显示输入框"/>
  
          <p id="u636"><span>其他：</span></p>
  <input id="u637_input" name = "operationOther" type="text" value=""/>

          <p id="u638"><span>现病史：</span></p>
  <select id="u639_input" name = "hpi" class = "test">
          <option selected value="0">无</option>
          <option value="1">有</option>
        </select>

  <input id="u640_input" name = "caseInformation" type="text" value="" placeholder = "有时显示输入框"/>
  ...
  <select id="u298_input" name="childrenNumber" class = "test">
  ...
  <input id="u373_input" name="childrenOther" type="text" value="" placeholder = "其他"/>
  ...
  <div id="u41" class="ax_形状" style="display:none">
        ...
        <select id="u379_input" name = "specialPosture" class = "test" data-label="性别">
          <option value="0">无</option>
          <option value="1">有</option>
        </select>
      ...
      <div id="u484" class="ax_水平线">
        ...
        <select id="u457_input" name = "throat" data-label="性别" class = "test">
          <option value="0">有</option>
          <option value="1">无</option>
        </select>

          <p id="u433"><span>阴毛：</span></p>
        <select id="u449_input" name = "pubicHair" data-label="性别" class = "test">
          <option value="0">正常</option>
      ...
      <div id="u482" class="ax_水平线">
        <hr style="border:1px dashed #B5B5B5;" />
          ...
          <p id="u600"><span>阴茎：</span></p>
	          <select id="u601_input" name = "penis" data-label="性别" class = "test">
		          <option value="0">正常</option>
		          <option value="1">异常</option>
		      </select>
		      
		    <input id="u602_input" name = "penisRemark" type="text" value="" placeholder = "异常时显示输入框"/>  
		      
          <p id="u603"><span>包皮：</span></p>

        <select id="u604_input" name = "foreskin" data-label="性别" class = "test">
          <option value="0">正常</option>
        ...
        <input id="u625_input" type="radio" value="0" name="bilateralTesticular"/>
      </div> -->
      
      <p id="u611"><span>体积： 左</span></p>
      
      <input id="u613_input" type="text" name = "leftTestis" value=""/>
      <p id="u617"><span>ml</span></p>
      <p id="u619"><span>右</span></p>
      <input id="u614_input" type="text" name = "rightTestis" value=""/>
      
      <p id="u620"><span>ml</span></p>
      
          <p id="u605"><span>未扪及：</span></p>
          <!-- <input id="u6251_input" type="radio" value="1" name="bilateralTesticular"/> -->
        <select id="u606_input" name = "without" data-label="性别" class = "test">
      ...
      <input id="u615_input" type="text" value="" name = "leftNodules"/>
      
      <p id="u618"><span>右</span></p>
      
      <input id="u616_input" type="text" value="" name = "rihgtNodules"/>
      
      <p id="u609"><span>精索静脉曲张：</span></p>
      
      <p id="u630"><span>无</span></p>
        <input id="u629_input" type="radio" value="0" name="varicocele"/>
        
        <p id="u632"><span>有</span></p>
        <input id="u631_input" type="radio" value="1" name="varicocele"/>
        
        <p id="u621"><span>部位：</span></p>
        
        <input id="u622_input" type="text" value="" name = "varicoseParts"/>
        
        <p id="u623"><span>程度：</span></p>
        
        <input id="u624_input" type="text" value="" name = "degree"/>

          <p id="u610"><span>其他：</span></p>
        
   		<input id="u448_input" name = "genitalOther" type="text" value=""/>
  </div>
      ...
      <div id="u205" class="ax_单选按钮">
        ...
        <select id="u147_input" name = "chest" class = "test">
          ...
          <option value="1">异常</option>
          <option selected value="未检查">未检查</option>
        </select>
