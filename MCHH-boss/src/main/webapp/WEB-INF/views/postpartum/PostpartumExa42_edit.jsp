...
/* 		} */
	    ...
	    <link href="${ctx }/static/css/PostpartumExa42Edit_styles1.css" type="text/css" rel="stylesheet"/>
	    ...
	    $(function(){
			...
			if(breast==0){
				...
				$("[name='breastRemark']").show();
			}
			var lochia = $("[name='lochia']").val();
			if(lochia==0){
				...
				$("[name='lochiaRemark']").show();
			}
			var uterus = $("[name='uterus']").val();
			if(uterus==0){
				...
				$("[name='uterusRemark']").show();
			}
			var wound = $("[name='wound']").val();
			if(wound==0){
				...
				$("[name='woundRemark']").show();
			}
			var vulva = $("[name='vulva']").val();
			if(vulva==0){
				...
				$("[name='vulvaRemark']").show();
			}
			var vagina = $("[name='vagina']").val();
			if(vagina==0){
				...
				$("[name='vaginaRemark']").show();
			}
			var cervical = $("[name='cervical']").val();
			if(cervical==0){
				$("[name='cervicalRemark']").hide();
			}else if(cervical==null){
				$("[name='cervicalRemark']").hide();
				$("[name='cervical']")[0].selectedIndex = -1;
			}else if(cervical==1){
				$("[name='cervicalRemark']").show();
			}
			var healthHandbook = $("[name='healthHandbook']").val();
			if(healthHandbook==null){
