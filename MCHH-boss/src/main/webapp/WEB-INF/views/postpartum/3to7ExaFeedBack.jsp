...
<div id="3to7FeedBack">
      ...
      <div id="u12" class="ax_文本段落">
          <p id="u13"><span style="font-size: 18px;">产后访视反馈单</span></p>
      </div>
      <!-- Unnamed (形状) -->
      ...
      <div id="u24" class="ax_水平线">
       ...
       <!-- Unnamed (形状) -->
      <div id="tiwen" class="ax_文本段落">
          <span>体&nbsp; 温：${postpartumExaDetailed.bodyTemperature }</span>
      </div>
      ...
      <div id="u54" class="ax_文本段落">
          	<c:if test="${postpartumExaOther.other!='' && postpartumExaOther.other!=null}">${postpartumExaOther.other}</c:if>
      </div>
      
            <!-- Unnamed (形状) -->
      <div id="u25" class="ax_文本段落">
          <p id="u26"><span>分类：<c:if test="${postpartumExa.result==0 }">未见异常</c:if><c:if test="${postpartumExa.result==1 }">异常  ${postpartumExa.remark }</c:if></span></p>
      </div>
