...
<head>
    ...
    <link href="${ctx}/static/css/addPrenatlArchives_styles.css" type="text/css" rel="stylesheet"/>
    ...
    function getDirectDate(lastMenses,predictId){
    	...
    	$(function(){
    		...
    		//家庭省份
     		provinces(provinceUrl,"u83_input","homePro");
      	  ...
      	  //户口省份
      	 provinces(provinceUrl,"u30_input","accPro");
      	  ...
      	  //男方
      	//家庭省份
   		  provinces(provinceUrl,"u144_input","manHomePro");
    	  ...
    	  //户口省份
    	 provinces(provinceUrl,"u115_input","manAccPro");
		  ...
		  $("#build").click(function(){
    		...
    		$("#u161_input")[0].selectedIndex = -1;
    		$("#u160_input")[0].selectedIndex = -1;
  ...
  <body>
  	...
  	<form action="${ctx}/prenatal/affirmPrenatalSaveUpdate" method="post" id="form">
    <div id="base" class="">
    	<div style="color: #0000FF;font-size: 20px;top: 10px;left: 10px;"><p>请确认档案信息！</p></div>
      <div id="title">
      	<div id="u4" class="ax_文本段落">
          <p id="u5"><span>档案编号:${archives.archivesCode }</span></p>
      	</div>
        <div id="u8" class="ax_文本段落">
          <p id="u9"><span>建档医院:${department.name }</span></p>
     	</div>
        <input type="hidden" id="archivesId" name="id" value="${archives.id }"/>
        <div id="u10" class="ax_文本段落">
          <p id="u11"><span>建档医生：${operatorPO.realName }</span></p>
        </div>
        
        <div id="u6" class="ax_文本段落">
          <input type="hidden" name="createTime" value="${time }"/>
          <p id="u7"><span>建档日期：<fmt:formatDate value="${archives.creatTime }" pattern="yyyy-MM-dd"/></span></p>
      </div>
      ...
      <div id="">
      	...
      	<div id="u2" class="ax_形状" style="background-color:#FFFFFF;border:1px solid #CCCCCC;">
        ...
        <div id="u14" class="ax_文本段落">
      	...
      	<div id="u19" class="ax_文本框">
        	<p id="u19_input" >${archives.name }</p>
      	</div>
        ...
        <div id="u25" class="ax_文本段落">
      	...
      	<div id="u27">
      		<input id="u27_input" type="text" name="idNo" placeholder="18位身份证号码" value="${archives.idNo }"/>
        <%-- <p id="u27_input" >${archives.idNo }</p> --%>
        </div>
        ...
        <div id="u73" class="ax_文本框">
        	...
        	<input type="text" id="u73_input" name="birth" readonly 
        style="color:#333333;cursor:pointer" onfocus="WdatePicker({dateFmt:'yyyyMMdd'})" 
        class="Wdate" value="<fmt:formatDate value="${archives.birthday }" pattern="yyyy-MM-dd"/>" tabindex="1" required>
      	</div>
        
        <div id="u23" class="ax_文本段落">
          <p id="u24"><span>年&nbsp; &nbsp;&nbsp;&nbsp;龄：<span id="age">${age }</span>岁</span></p>
      	</div>
        ...
        <div id="u38" class="ax_文本框">
        	<input id="u38_input" type="text" name="workUnit" placeholder="工作单位" value="${archives.workUnit }"/>
      	</div>
        ...
        <div id="u30" class="ax_下拉列表框">
            <select id="u30_input" name="accProvinceId">
            	<option selected value="${accProvince.id }">${accProvince.name }</option>
        	</select>
      	</div>
        ...
        <div id="u40" class="ax_文本框">
        	<input id="u40_input" name="accAddress" type="text" placeholder="非必填项" value="${archives.accAddress }"/>
      	</div>
        ...
        <div id="u84" class="ax_文本框">
        	<input id="u84_input" name="homeAddress" type="text" placeholder="非必填项" value="${archives.homeAddress }"/>
      	</div>
        ...
        <div id="u70" class="ax_文本框">
        	<input id="u70_input" type="text" name="telephone" placeholder="11位手机号" value="${archives.telephone }"/>
      	</div>
        ...
        <div id="u82" class="ax_文本框">
        	<input id="u82_input" name="urgentCall" type="text" placeholder="非必填项" value="${archives.urgentCall }"/>
      	</div>
      	
      	<div style="position: absolute;left: 610px;top: 299px; width: 82px;height: 15px;" class="ax_文本段落">
          <p id="u81"><span>末次月经：</span></p>
        </div>
        <div  class="ax_文本框" style="position: absolute;left: 677px;top: 294px;width: 145px;height: 25px;">
      ...
      <div id="manMsg">
      	...
      	<div id="u12" class="ax_形状" style="background-color:#FFFFFF;border:1px solid #CCCCCC;">
        ...
        <div id="u104" class="ax_文本框">
        	<p id="u104_input">${archives.manName }</p>
      	</div>
        ...
        <div id="u112" style="border: 0px;">
        	<input id="u112_input" name="manIdNo" type="text" placeholder="18位身份证号码" value="${archives.manIdNo }"/>
        	<%-- <p id="u112_input">${archives.manIdNo }</p> --%>
        </div>
        ...
        <div id="u137" class="ax_文本框">
        	...
        	<input type="text" id="u137_input" name="manBirth" readonly 
        style="color:#333333;cursor:pointer" onfocus="WdatePicker({dateFmt:'yyyyMMdd'})" 
        class="Wdate" value="<fmt:formatDate value="${archives.manBirthday }" pattern="yyyy-MM-dd"/>" tabindex="1" required>
      	</div>
        
        <div id="u108" class="ax_文本段落">
          <p id="u109"><span>年&nbsp; &nbsp; &nbsp;&nbsp;龄：<span id="manAge">${manAge }</span>岁</span></p>
        </div>
        ...
        <div id="u134" class="ax_文本框">
        	<input id="u134_input" type="text" name="manTele" placeholder="11位手机号" value="${archives.manTele }"/>
      	</div>
        ...
        <div id="u116" class="ax_文本框">
        	<input id="u116_input" name="manAccAddress" type="text" placeholder="非必填项" value="${archives.manAccAddress }"/>
      	</div>
        ...
        <div id="u154" class="ax_文本段落">
      	...
      	<div id="u145" class="ax_文本框">
        	<input id="u145_input" name="manHomeAddress" type="text" placeholder="非必填项" value="${archives.manHomeAddress }"/>
      	</div>
      ...
      <div id="otherMsg">
        ...
        <div id="u0" class="ax_形状" style="background-color:#FFFFFF;border:1px solid #CCCCCC;">
        ...
        <div id="u160" class="ax_下拉列表框">
        	<input id="grantSign" type="hidden" value=""/>
      ...
      <div id="u169" class="ax_形状" style="background-color:#009DD9">
          <p id="u170"><span id="build" style="cursor:pointer">确定</span></p>
      </div>
      <div id="u1690" class="ax_形状" style="background-color:#EE5F45">
          <p id="u1700"><span style="cursor:pointer" onclick="window.location.href='${ctx}/prenatal/list'">关闭</span></p>
      </div>
