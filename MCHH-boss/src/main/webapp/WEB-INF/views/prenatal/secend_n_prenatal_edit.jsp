    	...
    	$(function(){
			...
			$("#u037").click(function(){
				...
				if(status == "1"){
					...
					$("#u377").css("background-color","#0099DF");
					$("#u378").bind("click");
            ...
            <c:if test="${map.correctCount != '0' }">
      		...
      		<c:if test="${map.correctCount == '0' }">
	            ...
	            <div id="u3790" class="ax_形状" >
	          		<p id="u3800" style="cursor:pointer;" style="display: none"><span>专案记录</span></p>
	      		</div>
      		</c:if>
      		<input type="hidden" id = "correctCount" value="${map.correctCount }"/>
            
            
            <div id="u377" class="ax_形状" style="background-color:#0099DF">
      ...
      <div id="u37" name="foldDiv3" onclick="AutoFold('foldDiv4','u40',14)" class="ax_形状" style="background-color:#009DD9">
        ...
        <div id="" name="foldDiv6" style="height: 312px;">
            ...
            <div style="position: absolute;left: 520px;top: 656px;width: 80px;height: 15px;" class="ax_单选按钮">
                ...
                <input id="u7500" <c:if test="${map.supplemetnaryExam.scr == '-1'}">checked</c:if> style="position: absolute;left: 0px;" type="radio" value="-1" />
      		</div>
          ...
          <div id="u123" class="ax_文本框">
            ...
            <c:if test="${map.week < 11 || map.week == 21 || map.week > 26 }">
            	<div id="tangs" style="visibility: hidden;">
		            <div id="u83" class="ax_文本段落">
		          		<p id="u84"><span>唐筛：</span></p>
			  	  	</div>
        ...
        <div name="foldDiv8" style="height: 43px;">
            ...
            <div id="u130" class="ax_单选按钮">
                ...
                <input id="u130_input" type="radio" <c:if test="${map.correct == '1'}">disabled="disabled"</c:if> type="radio" <c:if test="${map.prenatal.evaluate == '0'}">checked="checked"</c:if> value="0" name="evaluate"/>
      		</div>
