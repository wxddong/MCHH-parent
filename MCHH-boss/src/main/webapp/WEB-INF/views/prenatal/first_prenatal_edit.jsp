...
<html>
  <head>
    ...
    <link href="${ctx}/static/css/first_prenatalEdit_styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script type="text/javascript">
    	...
    	$(function(){
			...
			var evaluateHidden = $("#evaluateHidden").val();
			if(evaluateHidden != "1"){
				$("#u431").hide();
			}
  ...
  font-weight:700;"</c:if>>
        ...
        <div id="" name="foldDiv2" style="height: 329px">
            ...
            <div id="u61" class="ax_文本段落">
          	...
          	<div id="u63" class="ax_文本框"><p style="position: absolute;top: 5px;" id="week">${map.motherhood.pregnancyWeeks }</p>
          	...
          	<div id="u74" class="ax_文本框"><p style="position: absolute;top: 5px;" id="day">${map.motherhood.pregnancyDays }</p>
        ...
        class="Wdate" value="<fmt:formatDate value="${map.motherhood.lastMenses }" pattern="yyyyMMdd"/>" tabindex="1" required>
      		</div>
        ...
        <div id="" name="foldDiv6" style="height: 111px">
            ...
            <div id="u254" class="ax_文本框">
        		<input id="u254_input" name="uterusRemark"  <c:if test="${map.gynecologcal.uterus != '1' && map.gynecologcal.uterus != '2' }">style="display: none;" </c:if> type="text" placeholder="异常时显示输入框" value="${map.gynecologcal.uterusRemark }"/>
      		</div>
      ...
      <div id="" name="foldDiv10" style="height: 43px">
        ...
        <div id="u429" class="ax_单选按钮">
            ...
            <input id="u429_input" <c:if test="${map.prenatalExa.evaluate == '1'}">checked</c:if> type="radio" value="1" name="evaluate"/>
      		...
      		<input type="hidden" id="evaluateHidden" value="${map.prenatalExa.evaluate}"/>
      ...
      <div id="" name="foldDiv14" style="height: 253px">
        ...
        <div id="u472" class="ax_下拉列表框">
            <select id="u472_input" onchange="only()" <c:if test="${map.prenatalReferral.folateNum == null }">class="selt"</c:if>>
              <option <c:if test="${map.prenatalReferral.folateNum != '0' }">selected</c:if> value="1">是</option>
