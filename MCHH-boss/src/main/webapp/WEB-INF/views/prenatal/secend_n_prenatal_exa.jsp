...
<html>
  <head>
    ...
    <link href="${ctx}/static/css/secendNprenatalExa_styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script type="text/javascript">
    	...
    	$(function(){
    		...
    		$("#u134_input").click(function(){
    			...
    			var hignRiskUrl = "${ctx}/com/config/highrisk/allSecondHighrisk?birthArchivesId="+birthArchivesId;
     						...
     						if(data.list[i].status == "1"){
     							if(data.list[i].score == "5"){
     								if(data.list[i].selected == "1"){
		     							...
		     							"</label><input class='in' onclick='return false' checked type='checkbox' value='"+data.list[i].id+"'name='evaluateRemark'/>"
		     							+"</div>";
     								}else{
	     								gudiFive += "<div class='gu5' style='position:absolute;width:250px;height:15px;left:24px;top:"+(121+a*30)+"px;vertical-align: baseline;'><label>"
		     							+"<p class='ps'><span>"+data.list[i].name+"</span></p>"+
			...
			$("#u376").click(function(){
				...
				var addUrl = "${ctx}/prenatal/addPrenatal2ToN";
				if(ba != 0){
					return false;
				}
			...
			$("#u378").click(function(){
				...
				var finishUrl = "${ctx}/prenatal/finishPrenatal2ToN";
			...
			$("#u380").click(function(){
				if(highSave == 0){
					...
					var zUrl = "${ctx}/com/config/highrisk/2ToNCheckRedioHighRisk?go=0"
					var birthArchivesId = $("#birthArchivesId").val();
					$.ajax({
	   					url:zUrl,
	   					type:"GET",
	   					data:{birthArchivesId:birthArchivesId},
	   					success:function(data){
	   						var str = "";
	   						var cStr = "";
	   						var i = 0;
	   						...
	   						if(data.list != null){
		   						for( ; i < data.list.length; i++){
		   							...
		   							str += "<div style='position:absolute;left:0px;top:"+(0+i*34)+"px;width:64px;"
		   							...
		   							+"left:64px;top:"+(0+i*34)+"px;width:372px;height:34px;text-align:center;' class='ax_单元格'>"
	   						...
	   						if(data.terms != null){
								for(; j < data.terms.length; j++){
		   							...
		   							str += "<div style='position:absolute;left:0px;top:"+(0+(i+j)*34)+"px;width:64px;"
		   							+"height:34px;text-align:center;' class='ax_单元格'><p style='position:absolute;"
		   							+"left:2px;top:10px;width:60px;word-wrap:break-word;'>"
		   							+"<span>"+(i+j+1)+"</span></p></div><div style='position:absolute;"
		   							+"left:64px;top:"+(0+(i+j)*34)+"px;width:372px;height:34px;text-align:center;' class='ax_单元格'>"
		   							+"<p style='position:absolute;left:2px;top:10px;width:368px;"
		   							...
		   							+"left:16px;top:0px;width:194px;word-wrap:break-word;'>"
		   							+"<span>已矫正&nbsp; &nbsp; ${time}</span></p></label><input class='ux' id='u022_input"+(i+j)
		   							+"' name='correct"+(i+j)+"' type='radio' value='1'/></div>";
		   						}
	   						}
							var ij = i+j;
							if(ij > 2){
					...
					var zUrl = "${ctx}/com/config/highrisk/2ToNCheckRedioHighRisk?go=1"
						var birthArchivesId = $("#birthArchivesId").val();
						$.ajax({
		   					url:zUrl,
		   					type:"GET",
			...
			$("#u037").click(function(){
				...
				if(status == "1"){
					...
					//var str = "<p id='u38000' style='cursor:pointer;' ><span>专案记录</span></p>";
					$("#u380").css("display","none");
					$("#u3800").css("display","block");
    	...
    	function getWeek(lastMenses,checkTime,weekId){
    		...
    		if(week >= 14 && week <= 20){
    			//唐筛
    			$("#tangs").css({"visibility":"visible"});
    			$("#nts").css({"visibility":"hidden"});
    			$("#sis").css({"visibility":"hidden"});
    		}else if(week >= 11 && week <= 13){
    			//nt
    			$("#tangs").css({"visibility":"hidden"});
    			$("#nts").css({"visibility":"visible"});
    			$("#sis").css({"visibility":"hidden"});
    		}else if(week >= 22 && week <= 26){
    			//四维
    			$("#tangs").css({"visibility":"hidden"});
    			$("#nts").css({"visibility":"hidden"});
    			$("#sis").css({"visibility":"visible"});
    		}else{
    			$("#tangs").css({"visibility":"hidden"});
    			$("#nts").css({"visibility":"hidden"});
    			$("#sis").css({"visibility":"hidden"});
  ...
  <body style="background-color: #FFFFFF">
    ...
    <form id="form" action="" method="post">
		<div id="title" style="background-color: #FFFFFF;border: 1px solid #CCCCCC;">
            ...
            <c:if test="${birthArchives.pregnantState != '1' && birthArchives.pregnantState != '2' }">
            ...
            <c:if test="${nomal == '1' }">
      		...
      		<input type="hidden" id="highRiskStatu" value="${birthArchives.riskSign}"/>
            <%-- <c:if test="${correctCount != '0' }">
	            <div id="u379" class="ax_形状" <c:if test="${birthArchives.riskSign != '1' }"> style="display: none" </c:if>>
	          		<p id="u380" style="cursor:pointer;"><span>专案管理</span></p>
	          		<p id="u3800" style="cursor:pointer;display: none" ><span>专案记录</span></p>
	      		</div>
      		</c:if> --%>
      		<c:if test="${correctCount == '-1' }">
      			<div id="u379" class="ax_形状" style="display: none">
	          		<p id="u380" style="cursor:pointer;"><span>专案管理</span></p>
	          		<p id="u3800" style="cursor:pointer;display: none" ><span>专案记录</span></p>
	      		</div>
      		</c:if>
      		<c:if test="${correctCount == '0' || correctCount == '2' }">
      			<div id="u379" class="ax_形状"  style="display: none">
	          		<p id="u380" style="cursor:pointer;"><span>专案管理</span></p>
	          		<p id="u3800" style="cursor:pointer;display: none" ><span>专案记录</span></p>
	      		</div>
		...
		<div id="baseMsg">
        	<div id="u10" class="ax_文本段落">
          		<p id="u11"><span>检查医院：&nbsp;${operator.department }</span></p>
      		</div>
            <div id="u12" class="ax_文本段落">
          		<p id="u13"><span>检查医生：${operator.realName }</span></p>
      		</div>
        ...
        <div id="">
            <div id="u393" class="ax_文本段落" <c:if test="${birthArchives.riskSign == '1' }">style="color:#EE5F45; font-family:'Arial Negreta', 'Arial';
  font-weight:700;"</c:if>>
          		<p id="u394"><span>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：${archives.name }</span></p>
      		</div>
            <div id="u395" class="ax_文本段落" <c:if test="${birthArchives.riskSign == '1' }">style="color:#EE5F45; font-family:'Arial Negreta', 'Arial';
  font-weight:700;"</c:if>>
        		<input type="hidden" name="archivesCode" value="${archives.archivesCode }"/>
        		<input type="hidden" id="archivesId" value="${archives.id }"/>
          		<p id="u396"><span>档案编号：${archives.archivesCode }</span></p>
      		</div>
            ...
            <div id="u391" class="ax_文本段落"><input type="hidden" id="week" value="${week }"/>
          		<p id="u392"><span>孕&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;周：</span><span id="birthWeek">${week }</span></p>
      		</div>
            
            <div id="u385" class="ax_文本段落">
          		<p id="u386"><span>出生日期：${birth }</span><span>&nbsp;</span></p>
      		</div>
            <div id="u397" class="ax_文本段落">
          		<p id="u398"><span>孕妇年龄：${age }</span></p>
      		</div>
          <div id="u387" class="ax_文本段落">
          	<input type="hidden" id="lastMenses" value="<fmt:formatDate value="${lastMenses }" pattern="yyyyMMdd"/>"/>
          		<p id="u388"><span>末次月经：<fmt:formatDate value="${lastMenses }" pattern="yyyy-MM-dd"/></span></p>
      	  </div>
          <div id="u389" class="ax_文本段落">
          		<p id="u390"><span>预&nbsp;&nbsp;产&nbsp;&nbsp;期：<fmt:formatDate value="${expectedDate }" pattern="yyyy-MM-dd"/></span></p>
   		  </div>
          
          <div id="u399" class="ax_文本段落">
          	<p id="u400"><span>联系电话：${archives.telephone }</span></p>
      	  </div>
          <div id="u401" class="ax_文本段落">
          	<p id="u402"><span>丈夫姓名：${archives.manName }</span><span>&nbsp;</span></p>
      	  </div>
          <div id="u403" class="ax_文本段落">
          	<p id="u404"><span>丈夫年龄：${manAge }</span></p>
      	  </div>
          <div id="u405" class="ax_文本段落">
          	<p id="u406"><span>丈夫电话：${archives.manTele }</span></p>
      	  </div>
      ...
      <div id="baseesg" name="foldDiv2" style="height: 123px">
            ...
            <div id="u32" class="ax_文本框">
              <input id="u32_input" type="text" name="weight" value=""/>
            </div>
            ...
            <div id="u45" class="ax_文本框">
        		<input id="u45_input" name="bloodHi" type="text" value=""/>
      		</div>
            ...
            <div id="u180" class="ax_文本框">
        		<input id="u180_input" name="uterusHight" type="text" value=""/>
      		</div>
            ...
            <div id="u183" class="ax_文本框">
        		<input id="u183_input" name="abdomen" type="text" value=""/>
      		</div>
            ...
            <div id="u185" class="ax_文本框">
        		<input id="u185_input" name="fetusPosition" type="text" value=""/>
      		</div>
            ...
            <div id="u184" class="ax_文本框">
        		<input id="u184_input" name="heartRate" type="text" value=""/>
      		</div>
        ...
        <div id="zhusu" name="foldDiv4" style="height: 107px;">
            ...
            <div id="u186" class="ax_多行文本框">
        		<textarea id="u186_input" name="chiefComplaint"></textarea>
      		</div>
        ...
        <div id="" name="foldDiv6" style="height: 312px;">
            ...
            <div id="u89" class="ax_文本框">
        		<input id="u89_input" name="hemoglobin" type="text" value=""/>
      		</div>
            ...
            <div id="u86" class="ax_文本框">
        		<input id="u86_input" name="bloodOthers" type="text" value=""/>
      		</div>
            ...
            <div id="u94" class="ax_文本框">
        		<input id="u94_input" name="proteinuria" type="text" value=""/>
      		</div>
            ...
            <div id="u95" class="ax_文本框">
        		<input id="u95_input" name="urineOthers" type="text" value=""/>
      		</div>
            ...
            <div id="u102" class="ax_文本框">
        		<input id="u102_input" name="bloodGlucose" type="text" value=""/>
      		</div>
            ...
            <div style="position: absolute;left: 255px;top: 567px;width: 80px;height: 15px;" class="ax_单选按钮">
                ...
                <input id="u1300_input" style="position: absolute;left: 0px;" type="radio" value="-1" name=""/>
      		</div>
            ...
            <div id="u113" class="ax_文本框">
        		<input id="u113_input" name="sgpt" type="text" value=""/>
      		</div>
            <div id="u61" class="ax_文本段落">
          		<p id="u62"><span>U/L</span></p>
      		</div>
      		...
      		<div style="position: absolute;left: 520px;top: 595px;width: 80px;height: 15px;" class="ax_单选按钮">
                ...
                <input id="u6100" style="position: absolute;left: 0px;" type="radio" value="-1" name=""/>
      		</div>
            
            <div id="u105" class="ax_文本段落">
          		<p id="u106"><span>血清谷草转氨酶：</span><span style="font-family:'Arial Negreta', 'Arial';font-weight:700;color:#FF0000;">&nbsp;<span id="u106_"></span></span></p>
      		</div>
            <div id="u114" class="ax_文本框">
        		<input id="u114_input" name="sgot" type="text" value=""/>
      		</div>
            <div id="u63" class="ax_文本段落">
      		...
      		<div style="position: absolute;left: 795px;top: 595px;width: 80px;height: 15px;" class="ax_单选按钮">
                ...
                <input id="u6300" style="position: absolute;left: 0px;" type="radio" value="-1" name=""/>
      		</div>
            ...
            <div id="u107" class="ax_文本段落">
          	...
          	<div id="u115" class="ax_文本框">
            	<input id="u115_input" name="albumin" type="text" value=""/>
          	</div>
          	...
          	<div style="position: absolute;left: 1050px;top: 595px;width: 80px;height: 15px;" class="ax_单选按钮">
                ...
                <input id="u6500" style="position: absolute;left: 0px;" type="radio" value="-1" name=""/>
      		</div>
            ...
            <div id="u116" class="ax_文本框">
        		<input id="u116_input" name="totalBilirubin" type="text" value=""/>
      		</div>
            <div id="u67" class="ax_文本段落">
      		...
      		<div style="position: absolute;left: 520px;top: 624px;width: 80px;height: 15px;" class="ax_单选按钮">
                ...
                <input id="u6700" style="position: absolute;left: 0px;" type="radio" value="-1" name=""/>
      		</div>
            ...
            <div id="u119" class="ax_文本框">
        		<input id="u119_input" name="dbil" type="text" value=""/>
      		</div>
            <div id="u117" class="ax_文本段落">
      		...
      		<div style="position: absolute;left: 795px;top: 624px;width: 80px;height: 15px;" class="ax_单选按钮">
                ...
                <input id="u11700" style="position: absolute;left: 0px;" type="radio" value="-1" name=""/>
      		</div>
            ...
            <div id="u120" class="ax_文本框">
        		<input id="u120_input" name="scr" type="text" value=""/>
      		</div>
            <div id="u75" class="ax_文本段落">
      		...
      		<div style="position: absolute;left: 520px;top: 656px;width: 80px;height: 15px;" class="ax_单选按钮">
                ...
                <input id="u7500" style="position: absolute;left: 0px;" type="radio" value="-1" name=""/>
      		</div>
            ...
            <div id="u121" class="ax_文本框">
        		<input id="u121_input" name="bun" type="text" value=""/>
      		</div>
            <div id="u79" class="ax_文本段落">
      		...
      		<div style="position: absolute;left: 795px;top: 656px;width: 80px;height: 15px;" class="ax_单选按钮">
                ...
                <input id="u7900" style="position: absolute;left: 0px;" type="radio" value="-1" name=""/>
      		</div>
          ...
          <div id="u123" class="ax_文本框">
        		<input id="u123_input" class="u187_input" style="display: none" name="bscanRemark" type="text" placeholder="异常时显示输入框" value=""/>
      		</div>
            
           <c:if test="${week < 11 || week ==21 || week >26 }">
	           <div id="tangs" style="visibility: hidden;">
		           <div id="u83" class="ax_文本段落">
		          		<p id="u84"><span>唐筛：</span></p>
			  	  </div>
		            <div id="u85" class="ax_下拉列表框">
		                <select id="u85_input" class="test" name="tangSyndrome">
		                  <option value="1">无异常</option>
		                  <option value="2">有异常</option>
		                  <option selected value="0">未检查</option>
		                </select>
		            ...
		            <div id="u122" class="ax_文本框">
		        		<input id="u122_input" class="u85_input" style="display: none" name="tangSyndromeRemark" type="text" placeholder="异常时显示输入框" value=""/>
		      		</div>
	      		</div>
	      		<div id="nts" style="visibility: hidden;">
		      		<div id="u83" class="ax_文本段落">
		          		<p id="u189"><span>&nbsp;NT：</span></p>
			  	    </div>
		            <div id="u85" class="ax_下拉列表框">
		                <select id="u190_input" class="test" name="nt">
		                  <option value="1">无异常</option>
		                  <option value="2">有异常</option>
		                  <option selected value="0">未检查</option>
		                </select>
		            ...
		            <div id="u122" class="ax_文本框">
		        		<input id="u191_input" class="u190_input" style="display: none" name="ntRemark" type="text" placeholder="异常时显示输入框" value=""/>
		      		</div>
		      	</div>
		      	<div id="sis" style="visibility: hidden;">
		      		<div id="u83" class="ax_文本段落">
		            ...
		            <div id="u122" class="ax_文本框">
		        		<input id="u195_input" class="u194_input" style="display: none" name="fourDimensionalRemark" type="text" placeholder="异常时显示输入框" value=""/>
		      		</div> 
		      	</div>
            </c:if>
           <c:if test="${week >= 14 && week <=20 }">
            ...
            <div id="u199" class="ax_文本框">
        		<input id="u199_input" class="u198_input" style="display: none" type="text" name="nstRemark" placeholder="异常时显示输入框" value=""/>
      		</div>
            ...
            <div id="u202" class="ax_多行文本框">
        		<textarea id="u202_input" name="others"></textarea>
      		</div>
        ...
        <div name="foldDiv8" style="height: 43px;">
            ...
            <div id="u130" class="ax_单选按钮">
                ...
                <input id="u130_input" <c:if test="${correctCount == '1'}">disabled="disabled"</c:if> type="radio" value="0" name="evaluate"/>
      		</div>
            <div id="u132" class="ax_单选按钮">
                <label for="u132_input">
                    <p id="u133"><span>&nbsp;异常</span></p>
                </label>
                <input id="u132_input" <c:if test="${correctCount == '1'}">checked="checked"</c:if> type="radio" value="1" name="evaluate"/>
      		</div>
            <div id="u134" <c:if test="${correctCount != '1'}">style="display: none"</c:if> class="ax_下拉列表框">
          ...
          <p id="u138" style="top: 5px; left: 1126px;"><span>收起</span></p>
       	...
       	<div name="foldDiv10" style="height: 148px;">
	        <div id="u139"  class="ax_多行文本框">
	        	<textarea id="u139_input" name="guidance"></textarea>
	      	</div>
        </div>
        ...
        <div name="foldDiv12" style="height: 198px;">
            ...
            <div id="u146" class="ax_单选按钮">
                ...
                <input id="u146_input" type="radio" value="0" name="referral"/>
      		</div>
            <div id="u148" class="ax_单选按钮">
                <label for="u148_input">
                    <p id="u149"><span> 有</span></p>
                </label>
                <input id="u148_input" type="radio" value="1" name="referral"/>
      		</div>
            ...
            <div id="u152" class="ax_文本框">
        		<input id="u152_input" type="text" name="reason" value=""/>
      		</div>
        	...
        	class="Wdate" value="${nextCheck }" tabindex="1" required>
      		</div>
            ...
            <div id="u164" class="ax_单选按钮">
                ...
                <input id="u164_input" type="radio" value="1" name="orderCheck" />
          	</div>>
          	<div id="u166" class="ax_单选按钮">
                <label for="u166_input">
                    <p id="u167"><span> 否</span></p>
                </label>
                <input id="u166_input" type="radio" value="0" name="orderCheck" />
      		</div>
            ...
            <div id="u176" class="ax_文本框">
        		<input id="u176_input" name="folateNum" type="text" placeholder="填写数量" value=""/>
      		</div>
     ...
     <!--  --------------------------------------------------------------------------------  -->                  
        ...
        <c:forEach items="${historyChecks }" var="historyCheck">
         ...
         <c:if test="${historyCheck.hemoglobin!=null }">
           ...
           <c:if test="${historyCheck.hemoglobin==null }">
                      ...
                      <td  style="border:0.5px solid #A6A6A6">
                          <p><span>
                          <c:if test="${historyCheck.bloodGlucose == '-1' }">未检查</c:if>
                          <c:if test="${historyCheck.bloodGlucose != '-1' }">${historyCheck.bloodGlucose }</c:if>
                          </span></p>
                      </td>
                       </c:if>
                          <c:if test="${historyCheck.bloodGlucose==null }">
      ...
      <div id="addZhuan"   class="easyui-dialog" title="角色" closed="true">
     ...
     <div id="u07" class="ax_表格">
		...
		<div id="inner" style="position: relative;;top:23px;height: 88px;width: 793px;border: 0px solid; ">
	        <!-- <div style="position: absolute;height: 1000px;width: 50px;background-color: blue;top: 10px;"></div> -->
      ...
      <div id="u034" class="ax_形状" style="background-color:#E9854F">
          <p id="u035" style="cursor:pointer" onclick="window.location.href='${ctx}/highriskprojectmanagement/list?birthArchiveId=${birthArchives.id }&archivesId=${birthArchives.archivesId }'"><span>专案记录</span></p>
      </div>
