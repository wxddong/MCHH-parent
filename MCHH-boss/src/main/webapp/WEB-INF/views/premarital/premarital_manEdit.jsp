  ...
  <head>
   ...
   <script type="text/javascript">
     ...
     /* 展开和收起 */
		 	...
		 	function onChange(id1,id2,status){
		 		  var text = $("#"+id1).val();
		 		  if (text == status) {
		 			 $("#"+id).hide();
				  }else{
		 	...
		 	$(function(){
			    ...
			    $("#u541_input").hide();
		 		...
		 		//手术史
		 		//$("#u635_input").hide();
		 		$("#u634_input").change(function(){
		 		  var surgeryHistory = $("#u634_input").val();
		 		  if (surgeryHistory == "1") {
					  $("#u635_input").show(); 
				  }else{
		 			 $("#u635_input").hide();
		 		...
		 		//现病史
		 		//$("#u640_input").hide();
		 		$("#u639_input").change(function(){
		 		  var hpi = $("#u639_input").val();
		 		  if (hpi == "0") {
		 			 $("#u640_input").hide();
				  }else{
					  $("#u640_input").show(); 
		 		...
		 		var specialPosture = $("#u379_input").val();
		 		  ...
		 		  if (specialPosture == null || specialPosture == "") {
		 			 $("#u380_input").hide();
				  }
		 		...
		 		var specialFace = $("#u383_input").val();
		 		  ...
		 		  if (specialFace == null || specialFace == "") {
		 			 $("#u384_input").hide();
				  }
		 		...
		 		var mentalState = $("#u387_input").val();
		 		  ...
		 		  if (mentalState == null || mentalState == "") {
		 			 $("#u388_input").hide();
				  }
		 		...
		 		var facialFeatures = $("#u52_input").val();
		 		  ...
		 		  if (facialFeatures == null || facialFeatures == "") {
		 			 $("#u53_input").hide();
				  }
		 		...
		 		var thyroidGland = $("#u399_input").val();
		 		  ...
		 		  if (thyroidGland == null || thyroidGland == "") {
		 			 $("#u400_input").hide();
				  }
	    		...
	    		//特殊疾病保存修改
	    		updateSpecialUrl = "${ctx}/specialdiseaseinfo/updateManSpecial"
	    		...
	    		$("#su254").click(function(){
		 		...
		 		//精索静脉曲张
				$("input[name^='varicocele']").click(function(){
			        
			        if($("#u629_input").attr("checked")){
			        	document.getElementById('u622_input').readOnly=true;
			        	document.getElementById('u624_input').readOnly=true;
			        }
			        
			        if($("#u631_input").attr("checked")){
			        	document.getElementById('u622_input').readOnly=false;
			        	document.getElementById('u624_input').readOnly=false;
			        }
			    });
		 	 			  ...
		 	 			  dataType:'json',
		 	 	 		  ...
		 	 	 		  success:function(data){
			 	 	 		  ...
			 	 	 		  for(var i = 0;i<data.list0.length;i++){
			 	 	 			  var s10 = "";
			 	 	 			  if(s1 ==data.list0[i].id ){
			 	 	 				  s10 = "selected";
			 	 	 			  }
			 	 	 			  str0 += "<option "+s10+" value="+data.list0[i].id+">"+data.list0[i].name+"</option>" ;
			 	 	 		  }
			 	 	 		  if (s11 == "6") {
			 	 	 				s100 = "selected";
							  }
			 	 	 		  str0 += "<option "+s100+" value='6'>其他</option>" ;
			 	 	 		  $("#u514_input").html(str0);
			 	 	 		  if ((s1 == null || s1 == "") && (s11 == null || s11 == "")) {
			 	 	 		  ...
			 	 	 		  for(var i = 0;i<data.list1.length;i++){
			 	 	 			  var s20 = "";
			 	 	 			  if (s2 == data.list1[i].id ) {
			 	 	 				  s20 = "selected";
								  }
			 	 	 			  str1 += "<option "+s20+" value="+data.list1[i].id+">"+data.list1[i].name+"</option>" ;
			 	 	 		  }
			 	 	 		  if (s22 == "16") {
			 	 	 			  s200 = "selected";
							  }
			 	 	 		  str1 += "<option "+s200+" value='16'>其他</option>" ;
			 	 	 		  $("#u518_input").html(str1);
			 	 	 		  if ((s2 == null || s2 == "") && (s22 == null || s22 == "")) {
			 	 	 		  ...
			 	 	 		  for(var i = 0;i<data.list2.length;i++){
			 	 	 			  var s30 = "";
			 	 	 			  if (s3 == data.list2[i].id ) {
			 	 	 				  s30 = "selected";
								  }
			 	 	 			  str2 += "<option "+s30+" value="+data.list2[i].id+">"+data.list2[i].name+"</option>" ;
			 	 	 		  }
			 	 	 		  if (s33 == "25") {
			 	 	 			  s300 = "selected";
							  }
			 	 	 		  str2 += "<option "+s300+" value='25'>其他</option>" ;
			 	 	 		  $("#u522_input").html(str2);
			 	 	 		  if ((s3 == null || s3 == "") && (s33 == null || s33 == "")) {
			 	 	 		  ...
			 	 	 		  for(var i = 0;i<data.list3.length;i++){
			 	 	 			  var s40 = "";
			 	 	 			  if (s4 == data.list3[i].id ) {
			 	 	 				  var s40 = "selected";
								  }
			 	 	 			  str4 += "<option "+s40+" value="+data.list3[i].id+">"+data.list3[i].name+"</option>" ;
			 	 	 		  }
			 	 	 		  if (s44 == "38") {
			 	 	 			  s400 = "selected";
							  }
			 	 	 		  str4 += "<option "+s400+" value='38'>其他</option>" ;
			 	 	 		  $("#u526_input").html(str4);
			 	 	 		  if ((s4 == null || s4 == "") && (s44 == null || s44 == "")) {
			 	 	 		  ...
			 	 	 		  for(var i = 0;i<data.list5.length;i++){
			 	 	 			  var s50 = "";
			 	 	 			  if (s5 == data.list5[i].id ) {
			 	 	 				  var s50 = "selected";
								  }
			 	 	 			  str5 += "<option "+s50+" value="+data.list5[i].id+">"+data.list5[i].name+"</option>" ;
			 	 	 		  }
			 	 	 		  if (s55 == "59") {
			 	 	 			  s500 = "selected";
							  }
			 	 	 		  str5 += "<option "+s500+" value='59'>其他</option>" ;
			 	 	 		  $("#u530_input").html(str5);
			 	 	 		  if ((s5 == null || s5 == "") && (s55 == null || s55 == "")) {
		 		...
		 		//阴茎
		 		//$("#u602_input").hide();
		 		$("#u601_input").change(function(){
		 		  var vagina = $("#u601_input").val();
		 		  if (vagina == "1") {
					  $("#u602_input").show(); 
				  }else{
		 			 $("#u602_input").hide();
				...
				for(var i = 0;i< a.length;i++){
				  ...
				  var finishUrl = "${ctx}/premaritalexainfo/finishManEdit"
				  var saveUrl = "${ctx}/premaritalexainfo/saveManAdd"
				  var manPresentationUrl = "${ctx}/premaritalexainfo/manPresentation"
				  var editUrl = "${ctx}/premaritalexainfo/saveManEdit"
				  var noPresentationUrl = "${ctx}/premaritalexainfo/noPresentation"
				  //保存
				  $("#u241").click(function(){
					  document.getElementById('u235_input').disabled=false;
				  ...
				  //进入男性婚检报告
		 		  $("#u06").click(function(){
		 			...
		 			window.location = manPresentationUrl+'?id='+id;
		 			//window.location = womanPresentationUrl+'?id='+node.id ;
		 		  ...
		 		  $("#u04").click(function(){
		 			...
		 			window.location = noPresentationUrl+'?id='+id;
				  ...
				  //完成
		 		  $("#u243").click(function(){
					...
					//睾丸
					 var leftTestis = $("#u613_input").val();
					 if (leftTestis == null || leftTestis == "") {
						alert("睾丸体积不能为空！");
						return false;
					 }
					 if (!smallNumber.test(leftTestis)) {
						alert("您输入的睾丸体积值格式错误！");
						return false;
					 }
					 var rightTestis = $("#u614_input").val();
					 if (rightTestis == null || rightTestis == "") {
						alert("睾丸体积不能为空！");
						return false;
					 }
					 if (!smallNumber.test(rightTestis)) {
						alert("您输入的睾丸体积值格式错误！");
						return false;
					 }
					 
					 //未扪及
					 var without = $("#u606_input").val();
					 if (without == null) {
						  alert("未扪及不能为空");
						  return false;
					 }
					...
					//结节
					 var leftNodules = $("#u615_input").val();
					 if (leftNodules == null || leftNodules == "") {
						alert("睾丸结节不能为空！");
						return false;
					 }
					 
					 var rihgtNodules = $("#u616_input").val();
					 if (rihgtNodules == null || rihgtNodules == "") {
						alert("睾丸结节不能为空！");
						return false;
					 }
					 
					 //精索静脉曲张
					 var varicocele = $("input[name='varicocele']:checked").val();
		 			  
		 			 if (varicocele == undefined) {
						alert("精索静脉曲张不能为空");
						return false;
					 }
		 			 if (varicocele == "0") {
					...
					//婚前卫生咨询
					 ...
					 document.getElementById('u235_input').disabled=false;
		 			  ...
		 			  $.ajax({
	    					...
	    					success:function(data){
	    						$("#archId").val( );
					 			showDialog_("提示","finishForm","moremiddle4",false);
  ...
  <body>
      <div id = "u666" class="ax_形状" >
		  ...
		  <div id="u239" class="ax_形状" style="background-color:#EE5F45;">
		          <p id="u240"><span>男性婚前医学检查</span></p>
		  </div>
...
<div id="u6" class="ax_形状" >
          ...
          <p id="u16"><span>姓名：${archivesInfoDetail.archivesInfo.manName }</span></p>
          <p id="u18"><span>性别：<input id = "manSex" type = "hidden" name = "manSex" value = "${archivesInfoDetail.archivesInfo.manSex }"/>
          ...
          <p id="u28"><span>出生日期：<span id = "manBirthday">${archivesInfoDetail.manBirthday }</span></span></p>
          <p id="u14"><span>年龄：</span></p>
          <p id="u8"><span>民族：${archivesInfoDetail.archivesInfo.manNation }</span></p>
          <p id="u20"><span>身份证号码：${archivesInfoDetail.archivesInfo.manIdNo }</span></p>
          <p id="u10"><span>工作单位：${archivesInfoDetail.archivesInfo.manWorkUnit }</span></p>
          <p id="u12"><span>职业：
          ...
          <p id="u26"><span>联系电话：${archivesInfoDetail.archivesInfo.manTele }</span></p>
          <p id="u254"><span>文化程度：
          ...
          <p id="u256"><span>对方姓名：${archivesInfoDetail.archivesInfo.name }</span></p>
          <p id="u258"><span>身份证号码：${archivesInfoDetail.archivesInfo.idNo }</span></p>
...
<div id="u3" class="ax_形状" style="display:none">
         <p id="u260"><span>血缘关系</span><span>：</span></p>
  		...
  		<select id="u262_input" <c:if test="${archivesInfoDetail.health.kinship == null }">
	          	class = "test"
          </c:if> name = "kinship">
  ...
  <input id="u358_input" name = "medicalOther" type="text" value="${archivesInfoDetail.health.medicalOther }"/>
          ...
          <p id="u633"><span>手术史：</span></p>
  <select id="u634_input" name = "surgeryHistory" <c:if test="${archivesInfoDetail.health.surgeryHistory == null }">
	          	class = "test"
          </c:if>>
  ...
  <input id="u635_input" name = "operation" type="text" value="${archivesInfoDetail.health.operation }" placeholder = "有时显示输入框"/>
  
          <p id="u636"><span>其他：</span></p>
  <input id="u637_input" name = "operationOther" type="text" value="${archivesInfoDetail.health.operationOther }"/>

          <p id="u638"><span>现病史：</span></p>
  <select id="u639_input" name = "hpi" <c:if test="${archivesInfoDetail.health.hpi == null }">
	          	class = "test"
          </c:if>>
  ...
  <input id="u640_input" name = "caseInformation" type="text" value="${archivesInfoDetail.health.caseInformation }" placeholder = "有时显示输入框"/>
  ...
  <select id="u295_input" name="marriageStatus" <c:if test="${archivesInfoDetail.health.marriageStatus == null }">
          ...
          <p id="u296"><span>子女：</span></p>
  <select id="u298_input" name="childrenNumber" <c:if test="${archivesInfoDetail.health.childrenNumber == null }">
	          	class = "test"
          </c:if>>
  ...
  <input id="u373_input" name="childrenOther" type="text" value="${archivesInfoDetail.health.childrenOther }" placeholder = "其他"/>
  ...
  <input id="u533_input" name="geneticHistory" style="display:none" type="text" value="${archivesInfoDetail.health.geneticHistoryRemark }" placeholder = "其他时显示输入框"/>
  <input id="u541_input" name="patientRelationship" type="text" value="${list11[8] }" placeholder = "患者与本人关系"/>
  ...
  <div id="u41" class="ax_形状" style="display:none">
        ...
        <select id="u379_input" name = "specialPosture" <c:if test="${archivesInfoDetail.physique.specialPosture == null }">
	          	class = "test"
          </c:if> data-label="性别">
      ...
      <div id="u484" class="ax_水平线">
        <hr style="border:1px dashed #B5B5B5;" />
          ...
          <p id="u641"><span>第二性征：</span></p>
          <p id="u431"><span>喉结：</span></p>
        <select id="u457_input" name = "throat" data-label="性别" <c:if test="${archivesInfoDetail.physique.throat == null }">
	          	class = "test"
          </c:if>>
          		<c:if test="${archivesInfoDetail.physique.throat == '0'}">
          			<option selected value="0">有</option>
          			<option value="1">无</option>
          		</c:if>
          		<c:if test="${archivesInfoDetail.physique.throat == '1'}">
          			<option value="0">有</option>
          			<option selected value="1">无</option>
          		</c:if>
          		<c:if test="${archivesInfoDetail.physique.throat == '' || archivesInfoDetail.physique.throat == null }">
          			<option value="0">有</option>
          			<option value="1">无</option>
          		</c:if>
        </select>

          <p id="u433"><span>阴毛：</span></p>
        <select id="u449_input" name = "pubicHair" data-label="性别" <c:if test="${archivesInfoDetail.physique.pubicHair == null }">
	          	class = "test"
          </c:if>>
      ...
      <div id="u482" class="ax_水平线">
        <hr style="border:1px dashed #B5B5B5;" />
          ...
          <p id="u600"><span>阴茎：</span></p>
	          <select id="u601_input" name = "penis" data-label="性别" <c:if test="${archivesInfoDetail.physique.penis == null }">
	          	class = "test"
          </c:if>>
		          <c:if test="${archivesInfoDetail.physique.penis == '0'}">
          			<option selected value="0">正常</option>
          			<option value="1">异常</option>
          		</c:if>
          		<c:if test="${archivesInfoDetail.physique.penis == '1'}">
          			<option value="0">正常</option>
          			<option selected value="1">异常</option>
          		</c:if>
          		<c:if test="${archivesInfoDetail.physique.penis == '' || archivesInfoDetail.physique.penis == null }">
          			<option value="0">正常</option>
          			<option value="1">异常</option>
          		</c:if>
		      </select>
		      
		    <input id="u602_input" name = "penisRemark" type="text" value="${archivesInfoDetail.physique.penisRemark }" placeholder = "异常时显示输入框"/>  
		      
          <p id="u603"><span>包皮：</span></p>

        <select id="u604_input" name = "foreskin" data-label="性别" <c:if test="${archivesInfoDetail.physique.foreskin == null }">
	          	class = "test"
          </c:if>>
          		<c:if test="${archivesInfoDetail.physique.foreskin == '0'}">
          			  <option selected value="0">正常</option>
			          <option value="1">过长</option>
			          <option value="2">包茎</option>
          		</c:if>
          		<c:if test="${archivesInfoDetail.physique.foreskin == '1'}">
          			  <option value="0">正常</option>
			          <option selected value="1">过长</option>
			          <option value="2">包茎</option>
          		</c:if>
          		<c:if test="${archivesInfoDetail.physique.foreskin == '2'}">
          			  <option value="0">正常</option>
			          <option value="1">过长</option>
			          <option selected value="2">包茎</option>
          		</c:if>
          		<c:if test="${archivesInfoDetail.physique.foreskin == '' || archivesInfoDetail.physique.foreskin == null }">
          			  <option value="0">正常</option>
			          <option value="1">过长</option>
			          <option value="2">包茎</option>
          		</c:if>
		...
		<p id="u607"><span>睾丸：</span></p>
		
		<%-- <div id="u" class="ax_单选按钮">
            <p id="u626"><span>双侧扪及</span></p>
        <input id="u625_input" type="radio" value="0"
        	<c:if test="${archivesInfoDetail.physique.bilateralTesticular == '0'}">
          			  checked = "checked"
          		</c:if>
         name="bilateralTesticular"/>
      </div> --%>
      
      <p id="u611"><span>体积： 左</span></p>
      
      <input id="u613_input" type="text" name = "leftTestis" value="${archivesInfoDetail.physique.leftTestis }"/>
      <p id="u617"><span>ml</span></p>
      <p id="u619"><span>右</span></p>
      <input id="u614_input" type="text" name = "rightTestis" value="${archivesInfoDetail.physique.rightTestis }"/>
      
      <p id="u620"><span>ml</span></p>
      
          <p id="u605"><span>未扪及：</span></p>
          <%-- <input id="u6251_input" type="radio" value="1"
          <c:if test="${archivesInfoDetail.physique.bilateralTesticular == '1'}">
          			  checked = "checked"
          		</c:if> name="bilateralTesticular"/> --%>
        <select id="u606_input" name = "without" data-label="性别" <c:if test="${archivesInfoDetail.physique.without == null }">
	          	class = "test"
          </c:if>>
          		<c:if test="${archivesInfoDetail.physique.without == '0'}">
          			  <option selected value="0">左</option>
          			  <option value="1">右</option>
          		</c:if>
          		<c:if test="${archivesInfoDetail.physique.without == '1'}">
          			  <option value="0">左</option>
          			  <option selected value="1">右</option>
          		</c:if>
          		<c:if test="${archivesInfoDetail.physique.without == '' || archivesInfoDetail.physique.without == null }">
          			  <option value="0">左</option>
          			  <option value="1">右</option>
          		</c:if>
        </select>
        
        <!-- <p id="u608"><span>附睾：</span></p> -->
        
        <!-- <div id="u" class="ax_单选按钮">
          Unnamed ()
            <p id="u628"><span>双侧正常</span></p>
        <input id="u627_input" type="radio" value="radio" name="normalEpididymis"/>
      </div> -->
      
      <p id="u612"><span>结节： 左</span></p>
      
      <input id="u615_input" type="text" value="${archivesInfoDetail.physique.leftNodules }" name = "leftNodules"/>
      
      <p id="u618"><span>右</span></p>
      
      <input id="u616_input" type="text" value="${archivesInfoDetail.physique.rihgtNodules }" name = "rihgtNodules"/>
      
      <p id="u609"><span>精索静脉曲张：</span></p>
      
      <p id="u630"><span>无</span></p>
        <input id="u629_input" type="radio" value="0"
        <c:if test="${archivesInfoDetail.physique.varicocele == '0'}">
          			  checked = "checked"
          		</c:if> name="varicocele"/>
        
        <p id="u632"><span>有</span></p>
        <input id="u631_input" type="radio" value="1"
        <c:if test="${archivesInfoDetail.physique.varicocele == '1'}">
          			  checked = "checked"
          		</c:if> name="varicocele"/>
        
        <p id="u621"><span>部位：</span></p>
        
        <input id="u622_input" type="text" value="${archivesInfoDetail.physique.varicoseParts }" name = "varicoseParts"/>
        
        <p id="u623"><span>程度：</span></p>
        
        <input id="u624_input" type="text" value="${archivesInfoDetail.physique.degree }" name = "degree"/>

          <p id="u610"><span>其他：</span></p>
        
   		<input id="u448_input" name = "genitalOther" type="text" value="${archivesInfoDetail.physique.genitalOther }"/>
  </div>
