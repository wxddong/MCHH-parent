...
<script type="text/javascript">
		$(function() {
	    	  ...
	    	  var editArchUrl = "${ctx}/archivesinfo/updateMan";
	    	  ...
	    	  //家庭省份
	   		  provinces(provinceUrl,"u079_input","manHomePro");
	    	  ...
	    	  //户口省份
	    	 provinces(provinceUrl,"u032_input","manAccPro");
	    	  ...
	    	  $("#u072_input").change(function(){
				...
				//根据身份证号获取出生日期
				/* var manIdNo = $("#u029_input").val();
				
				var birth = manIdNo.substr(6,8);
			   ...
			   //根据出生日期计算年龄
	  		   var manBirthday = $("#u069_input").val();
			   
	  		   var nowdate = new Date();
	  		   var age = nowdate.getFullYear() - manBirthday.substr(0,4);
	  		   $("#u19_1").html(age + "岁");
 ...
 <div id="0base" class="">
	...
	<form id="addOrUpdate" action="" method="post">
      ...
      <div id="u021" class="ax_文本框">
        ...
        <input id="u021_input" name = "manName" readonly= "true" type="hidden" value="${archivesInfoDetail.archivesInfo.manName }" placeholder = ""/>
      </div>
      ...
      <div id="u020" class="ax_下拉列表框">
        <select id="u020_input" name = "manSex" data-label="性别">
          <c:if test="${archivesInfoDetail.archivesInfo.manSex == '0' }">
          	<option value="0" selected="selected">女</option>
          	<option value="1">男</option>
          </c:if>
          <c:if test="${archivesInfoDetail.archivesInfo.manSex == '1' }">
          	<option value="0" >女</option>
          	<option value="1" selected="selected">男</option>
          </c:if>
          <c:if test="${archivesInfoDetail.archivesInfo.manSex == '2' }">
          	<option value="0" >女</option>
          	<option value="1">男</option>
      ...
      <div id="u024" class="ax_下拉列表框">
        <select id="u024_input" name = "manInte">
        	<c:if test="${archivesInfoDetail.archivesInfo.manInte == '1'}">
		          <option value="0">中国</option>
		          <option value="1" selected="selected">外国</option>
          	</c:if>
          	<c:if test="${archivesInfoDetail.archivesInfo.manInte == '0'}">
      ...
      <div id="u055" class="ax_下拉列表框">
        <select id="u055_input" name = "manNation">
          	<c:if test="${archivesInfoDetail.archivesInfo.manNation == '汉'}">
		          <option value="汉" selected="selected">汉</option>
		          <option value="回">回</option>
          	</c:if>
          	<c:if test="${archivesInfoDetail.archivesInfo.manNation == '回'}">
          		  <option value="汉">汉</option>
		          <option value="回" selected="selected">回</option>
          	</c:if>
          	<c:if test="${archivesInfoDetail.archivesInfo.manNation == '其他'}">
          		  <option value="汉">汉</option>
		          <option value="回">回</option>
      ...
      <div id="u029" class="ax_文本框">
        ...
        <input id="u029_input" name = "manIdNo" type="text" value="${archivesInfoDetail.archivesInfo.manIdNo }"/>
      </div>
      ...
      <div id="u069" class="ax_文本框">
        <%-- <input id="u069_input" name = "manBirthday" type="text" value="${archivesInfoDetail.manBirthday }"/> --%>
        <input type="text" id="u069_input" name="manBirthday"
        ...
        class="Wdate" value="${archivesInfoDetail.manBirthday }" tabindex="1" required>
      </div>
      ...
      <div id="u041" class="ax_下拉列表框">
        <select id="u041_input" name = "manEducation">
        	<c:if test="${archivesInfoDetail.archivesInfo.manEducation == '0'}">
          	...
          	<c:if test="${archivesInfoDetail.archivesInfo.manEducation == '1'}">
          		  <option value="9">不详</option>
       		...
       		<c:if test="${archivesInfoDetail.archivesInfo.manEducation == '2'}">
       			  <option value="9">不详</option>
       			  <option value="0">小学</option>
		          <option value="1">初中</option>
       		...
       		<c:if test="${archivesInfoDetail.archivesInfo.manEducation == '3'}">
       			  <option value="9">不详</option>
       			  <option value="0">小学</option>
		          <option value="1">初中</option>
		          <option value="2">高中</option>
       		...
       		<c:if test="${archivesInfoDetail.archivesInfo.manEducation == '4'}">
       			  <option value="9">不详</option>
       			  <option value="0">小学</option>
		          <option value="1">初中</option>
		          <option value="2">高中</option>
       		...
       		<c:if test="${archivesInfoDetail.archivesInfo.manEducation == '5'}">
       			  <option value="9">不详</option>
       			  <option value="0">小学</option>
		          <option value="1">初中</option>
		          <option value="2">高中</option>
       		...
       		<c:if test="${archivesInfoDetail.archivesInfo.manEducation == '6'}">
       			  <option value="9">不详</option>
       			  <option value="0">小学</option>
		          <option value="1">初中</option>
		          <option value="2">高中</option>
       		...
       		<c:if test="${archivesInfoDetail.archivesInfo.manEducation == '7'}">
       			  <option value="9">不详</option>
       			  <option value="0">小学</option>
		          <option value="1">初中</option>
		          <option value="2">高中</option>
       		...
       		<c:if test="${archivesInfoDetail.archivesInfo.manEducation == '8'}">
       			  <option value="9">不详</option>
       			  <option value="0">小学</option>
		          <option value="1">初中</option>
		          <option value="2">高中</option>
            ...
            <c:if test="${archivesInfoDetail.archivesInfo.manEducation == '9'}">
      ...
      <div id="u058" class="ax_下拉列表框">
        <select id="u058_input" name = "manHouType">
        	<c:if test="${archivesInfoDetail.archivesInfo.manHouType == '0'}">
		          <option selected value="0">本地</option>
		          <option value="1">外地</option>
       		</c:if>
       		<c:if test="${archivesInfoDetail.archivesInfo.manHouType == '1'}">
      ...
      <div id="u061" class="ax_下拉列表框">
        <select id="u061_input" name = "manAccType">
        	<c:if test="${archivesInfoDetail.archivesInfo.manAccType eq '0'}">
       			<option value="1">非农户籍</option>
          		<option value="0" selected>农业户籍</option>
       		</c:if>
       		<c:if test="${archivesInfoDetail.archivesInfo.manAccType eq '1'}">
      ...
      <div id="u035" class="ax_下拉列表框">
        <select id="u035_input" name = "manOccupation">
      ...
      <div id="u040" class="ax_文本框">
        <input id="u040_input" name = "manWorkUnit" type="text" value="${archivesInfoDetail.archivesInfo.manWorkUnit }"/>
      </div>
      ...
      <div id="u032" class="ax_下拉列表框">
      	<input type="hidden" id="manAccPro" value="${archivesInfoDetail.provinceInfo.id }"/>
        <select id="u032_input" name = "manAccProvinceId">
      ...
      <div id="u070" class="ax_下拉列表框">
        <select id="u070_input" name = "manAccCityId">
      ...
      <div id="u071" class="ax_下拉列表框">
        <select id="u071_input" name = "manAccCountyId">
      ...
      <div id="u072" class="ax_下拉列表框">
        <select id="u072_input" name = "manAccTownshipId">
      ...
      <div id="u073" class="ax_下拉列表框">
        <select id="u073_input" name = "manAccVillageId">
      ...
      <div id="u042" class="ax_文本框">
        <input id="u042_input" name = "manAccAddress" type="text" value="${archivesInfoDetail.archivesInfo.manAccAddress }"/>
      </div>
      ...
      <div id="u079" class="ax_下拉列表框">
      	<input type="hidden" id="manHomePro" value="${archivesInfoDetail.provinceInfo1.id }"/>
        <select id="u079_input" name = "manHomeProvinceId">
      ...
      <div id="u091" class="ax_下拉列表框">
        <select id="u091_input" name = "manHomeCityId">
      ...
      <div id="u092" class="ax_下拉列表框">
        <select id="u092_input" name = "manHomeCountyId">
      ...
      <div id="u093" class="ax_下拉列表框">
        <select id="u093_input" name = "manHomeTownshipId">
      ...
      <div id="u094" class="ax_下拉列表框">
        <select id="u094_input" name = "manHomeVillageId">
      ...
      <div id="u080" class="ax_文本框">
        <input id="u080_input" name = "manHomeAddress" type="text" value="${archivesInfoDetail.archivesInfo.manHomeAddress }"/>
      </div>

      <!-- Unnamed (形状) -->
      <div id="u074" class="ax_文本段落">
        
          <p id="u075"><span>同上</span></p>
      ...
      <div id="u066" class="ax_文本框">
        <input id="u066_input" name = "manTele" type="text" value="${archivesInfoDetail.archivesInfo.manTele }"/>
      </div>
      ...
      <div id="u078" class="ax_文本框">
        <input id="u078_input" name = "manUrgentCall" type="text" value="${archivesInfoDetail.archivesInfo.manUrgentCall }"/>
      </div>
      ...
      <div id="u0103" class="ax_文本框">
        ...
        <input id="u0103_input" name = "name" type="hidden" value="${archivesInfoDetail.archivesInfo.name }"/>
      </div>
      ...
      <div id="u0106" class="ax_文本框">
        ...
        <input id="u0106_input" name = "idNo" type="text" value="${archivesInfoDetail.archivesInfo.idNo }"/>
      </div>
      ...
      <div id="u0109" class="ax_文本框">
        <input id="u0109_input" name = "telephone" type="text" value="${archivesInfoDetail.archivesInfo.telephone }"/>
      </div>
      </form>
    </div>
