				...
				$("input[name^='vaginalDischarge']").click(function(){
		 		...
		 		$("input[name^='checkResult']").click(function(){
			        ...
			        if($("#u215_input").attr("checked")){
			        	...
			        	document.getElementById('u499_input').disabled=false;
			        	document.getElementById('u504_input').disabled=false;
			        	...
			        	document.getElementById('u494_input').readOnly=false;
			        	document.getElementById('u505_input').readOnly=false;
				...
				$("#u192_input").change(function(){
		 		  ...
		 		  $("#u243").click(function(){
					...
					//乙型肝炎表面抗原
		 			...
		 			//疾病诊断
					 var diseaseDiagnosis = $("#u494_input").val();
					 if (diseaseDiagnosis == null || diseaseDiagnosis == "") {
						 alert("疾病诊断不能为空！");
							return false;
					 }
					...
					//婚前卫生咨询
					 ...
					 //检查结果
					 var checkResult = $.trim($("input[name^='checkResult']:checked").val());
		 			  ...
		 			  $.ajax({
	    					...
	    					success:function(data){
	    						$("#archId").val( );
					 			showDialog_("提示","finishForm","moremiddle2",false);
	 	 			  ...
	 	 			  dataType:'json',
	 	 	 		  ...
	 	 	 		  success:function(data){
		 	 	 		  ...
		 	 	 		  for(var i = 0;i<data.list4.length;i++){
		 	 	 			  var s40 = "";
		 	 	 			  if (s4 == data.list4[i].id ) {
		 	 	 				  var s40 = "selected";
							  }
		 	 	 			  str4 += "<option "+s40+" value="+data.list4[i].id+">"+data.list4[i].name+"</option>" ;
		 	 	 		  }
		 	 	 		  if (s44 == "38") {
		 	 	 			  s400 = "selected";
						  }
...
<div id="u3" class="ax_形状" style="display:none;">
  ...
  <select id="u368_input" name = "amount" <c:if test="${archivesInfoDetail.health.amount == null }">
        ...
        <input type="text" id="u354_input" name="lastMenstrualPeriod" readonly 
  ...
  <input id="u376_input" name="childrenOther" type="text" value="${archivesInfoDetail.health.childrenOther }" placeholder = "其他"/>
          ...
          <p id="u275"><span>与遗传有关的家族：</span></p>
 ...
 <div id="u220" class="ax_形状" style="display:none">
      ...
      <div id="u225" class="ax_单选按钮">
        ...
        <input type="text" id="u235_input" name="referralDate" readonly 
        style="color:#333333;cursor:pointer" onfocus="WdatePicker({dateFmt:'yyyyMMdd'})" 
        class="Wdate" value="${archivesInfoDetail.referralDate }" tabindex="1" required>
      
        
          <p id="u236"><span>预约复诊日期：</span></p>
        <input type="text" id="u238_input" name="appointmentDate" readonly 
        style="color:#333333;cursor:pointer" onfocus="WdatePicker({dateFmt:'yyyyMMdd'})" 
        ...
        <input type="text" id="u511_input" name="issuedByDate" readonly 
        style="color:#333333;cursor:pointer" onfocus="WdatePicker({dateFmt:'yyyyMMdd'})" 
