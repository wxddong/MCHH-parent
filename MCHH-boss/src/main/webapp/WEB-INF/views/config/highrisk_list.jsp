...
<html class="panel-fit">
  <head>
	...
	<script type="text/javascript">
    	...
    	var listUrl = "${ctx}/com/config/highrisk/list";
		var delUrl = "${ctx}/com/config/highrisk/del";
	    var updateUrl = "${ctx}/com/config/highrisk/updateView";
	    var addhightUrl = "${ctx}/com/config/highrisk/addrisk";
			...
			$("#save").click(function(){
				...
				var typeurl="${ctx}/com/config/highrisk/getByname"+'?name='+name;
				$.ajax({
		...
		function edit(node){
			...
			showDialog_URl('修改高危因素','addOrUpdate',updateUrl+'?id='+node.id,'maxiddle5');
		...
		function add(){
			...
			showDialog_('新建孕产期高危因素','addOrUpdateWin','maxiddle5');
		}
		...
		<div style="position:relative; border: 1px solid #cccccc; top:-19px;height: 70px;width: 1120px;line-height: 40px;">
			 ...
			 <div style="top:17px;left:40px;position:absolute;">
				...
				<input type="text" name="name"style="width:180px;height:27px;border:1px solid #cccccc"/>
				 高危评分:
				 <select class="easyui-validatebox select" name="score" id="score" style="width:180px;border:1px solid #cccccc;" >
				 ...
				 所属分类:
				 <select class="easyui-validatebox select" name="status" id="status"  value="list.isvalid" style="width:180px;border:1px solid #cccccc;">
	    ...
	    <div id="addOrUpdateWin" class="easyui-dialog" title="预约检查" closed="true">
			 ...
			 <table class="datagrid-body" width="100%">
				    ...
				    <tr>
						...
						<td>
							 <select class="easyui-validatebox select"  name="score" id="sco" style="width:180px;border:1px solid #cccccc;">
									<option  value=""></option>
									<option  value="5">5</option>
									<option  value="10">10</option>
									<option  value="20">20</option>
			      ...
			      <tr>
					...
					<td>
						 <select class="easyui-validatebox select"  name="status" id="statu" style="width:180px;border:1px solid #cccccc;">
