...
public class ResourcesVO {
	...
	public String toString() {
		return "ResourcesVO [flag=" + flag + ", grantFlag=" + grantFlag + ", id=" + id + ", logFlag=" + logFlag
				+ ", logMethod=" + logMethod + ", logUri=" + logUri + ", name=" + name + ", onum=" + onum
				+ ", parentId=" + parentId + ", remark=" + remark + ", type=" + type + ", uri=" + uri + "]";
	}
