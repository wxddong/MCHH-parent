...
public class SDKServiceLocator extends org.apache.axis.client.Service implements SDKService_Service {
    ...
    private java.lang.String SDKService_address = PropertyUtil.getProperty().getString("YIMEI_URL");
