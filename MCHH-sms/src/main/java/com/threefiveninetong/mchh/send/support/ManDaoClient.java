...
public class ManDaoClient {
	 ...
	 * 构造函数
	 */
	public ManDaoClient(String sn, String password)
	...
	public String mdgxsendIng(String mobile, String content, String ext,
			String rrid) throws Exception{
			return mdsmssend(mobile,URLEncoder.encode(content,InitDictionary.MD_CHARSET),ext,"",rrid,"").replace(" ","");
	}
