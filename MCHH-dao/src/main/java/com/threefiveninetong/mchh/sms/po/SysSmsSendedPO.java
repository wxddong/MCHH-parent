 ...
 * @Title: SysSmsSendedPO.java
 * @Prject: MCHH-dao
 * @Package: com.threefiveninetong.mchh.sms.po 
 * @Description: TODO
 * @author: dingjh   
...
/**
 * @ClassName: SysSmsSendedPO 
 * @Description: TODO
 * @author: dingjh
 * @date: 2016-09-18 15:36:09 
 */
public class SysSmsSendedPO implements Serializable {
	 ...
	 * 构造 
	 */
	public SysSmsSendedPO() {
	}
	
	public SysSmsSendedPO( String id,  String sender, String receiver, String content, Date createtime, String smstype, Date sendtime, String sendlevel, String platformCode, String enterpriseid, String masdownmsgid, String masdownstate, String receiverdescription, String downstate, String channel) {
				this.sender = sender;
