...
/**
 * @ClassName: PhysiqueExaInfoPO 
 * @Description: TODO
 * @author: dingjh
 * @date: 2016-08-19 11:33:33 
 */
public class PhysiqueExaInfoPO implements Serializable {
	 ...
	 * 构造 
	 */
	public PhysiqueExaInfoPO() {
	}
	
	public PhysiqueExaInfoPO( String id,  String marriageTaId, String bloodHi, String bloodLow, String bloodType, String yinYang, String specialPosture, String postureRemark, String specialFace, String faceRemark, String mentalState, String stateRemark, String intelligence, String exceptionTypes, String skinHair, String skinHairNote, String facialFeatures, String facialFeaturesRemark, String thyroidGland, String thyroidGlandRemark, String heartRate, String heartRhythm, String heartRhythmRemark, String noise, String noiseRemark, String lung, String lungRemark, String liver, String liverRemark, String limbs, String limbsRemark, String others, String throat, String pubicHair, String breast, String breastRemark, String anusVulva, String anusVulvaRemark, String secretions, String secretionsRemark, String vulvaVagina, String vulvaVaginaRemark, String vulva, String vulvaRemark, String vagina, String vaginaRemark, String cervical, String cervicalRemark, String uterus, String uterusRemark, String attachment, String attachmentRemark, String attachmentOther, String vaginalExamination, String penis, String penisRemark, String foreskin, String bilateralTesticular, String leftTestis, String rightTestis, String without, String normalEpididymis, String leftNodules, String rihgtNodules, String varicocele, String varicoseParts, String degree, String genitalOther) {
