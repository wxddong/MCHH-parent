...
public class TownShipHealthCenterStatisticsPO {
	...
	public TownShipHealthCenterStatisticsPO() {
	}
	...
	public TownShipHealthCenterStatisticsPO(String date1, String date2, String date3, String date4, String date5,
			...
			String date41, String date42, String date43) {
		super();
		this.date1 = date1;
		this.date2 = date2;
		this.date3 = date3;
