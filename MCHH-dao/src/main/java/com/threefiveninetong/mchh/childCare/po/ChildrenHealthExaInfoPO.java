 ...
 * @Title: ChildrenHealthExaInfoPO.java
 * @Prject: MCHH-dao
...
/**
 * @ClassName: ChildrenHealthExaInfoPO 
 * @Description: TODO
 * @author: dingjh
 * @date: 2016-11-04 14:36:02 
 */
public class ChildrenHealthExaInfoPO implements Serializable {
	...
	private ChildrenReferralInfoPO childrenReferralInfoPO;
	...
	public ChildrenReferralInfoPO getChildrenReferralInfoPO() {
		return childrenReferralInfoPO;
	}

	public void setChildrenReferralInfoPO(ChildrenReferralInfoPO childrenReferralInfoPO) {
		this.childrenReferralInfoPO = childrenReferralInfoPO;
	}

	/**
	 * 构造 
	 */
	public ChildrenHealthExaInfoPO() {
	}
	
	public ChildrenHealthExaInfoPO( String id,  String archivesId, String hospitalId, String editStatus, String deltetSign, String guidance, Date creatTime, Date updateTime, String normalSign, String stageSign) {
